...
-- -----------------------------------------------------
-- Table `Platto_database`.`Tables`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Platto_database`.`Tables` ;

CREATE TABLE IF NOT EXISTS `Platto_database`.`Tables` (
...
CREATE TABLE IF NOT EXISTS `Platto_database`.`Command` (
  ...
  CONSTRAINT `fk_Command_Tables`
    ...
    REFERENCES `Platto_database`.`Tables` (`table_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
